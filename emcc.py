  ...
  try:
    with ToolchainProfiler.profile_block('parse arguments and setup'):
      ...
      if shared.Settings.BINARYEN:
        ...
        if shared.Settings.BINARYEN_ASYNC_COMPILATION == 1 and 'interpret' not in shared.Settings.BINARYEN_METHOD and 'asmjs' not in shared.Settings.BINARYEN_METHOD and 'interpret-asm2wasm' not in Settings.BINARYEN_METHOD and not Settings.RUNNING_JS_OPTS:
