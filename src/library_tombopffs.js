	...
	module.exports = {
	  ...
	  connectSocket: function connectSocket() {
	    return new Promise(function (resolve, reject) {
	      if (TOMBOPFFS.offline || !Module.remoteFileSystemURL) {
	        return reject(null);
	      }
	      if (TOMBOPFFS.websocket) {
	        return resolve(TOMBOPFFS.websocket);
	      }
	      var websocket = new TomboWebSocket(Module.remoteFileSystemURL);
	  ...
	  fetchAllRemoteEntries: function fetchAllRemoteEntries() {
	    ...
	    return TOMBOPFFS.connectSocket().then(function (socket) {
	      socket.send({
	        type: 'fetch-all',
	  ...
	  reconcile: function reconcile(source, destination) {
	    ...
	    */
	    ...
	    var updateMTime = function updateMTime(key) {
	    ...
	    if (destination.type === 'memfs') {
	      ...
	      return TOMBOPFFS.connectSocket().then(function (socket) {
	        ...
	        try {
	          ...
	          for (var _iterator3 = replace_entries[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            _loop();
	          }
	        } catch (err) {
	        ...
	        try {
	          for (var _iterator4 = delete_entries[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            ...
	            destination.entries.delete(_key2);
	          }
	        } catch (err) {
...
/******/ ]);
      // replace TOMBOPFFS
      delete this.mount;
      for (var key in tombopffs) {
        if (tombopffs.hasOwnProperty(key)) {
          this[key] = tombopffs[key];
        }
      }
